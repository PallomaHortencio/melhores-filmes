    ...
    <SafeAreaView>
      <ScrollView>
        <Text style={estilos.titulo}>
          Política de Privacidade para o app Melhores Filmes
        </Text>

        <Text style={estilos.texto}>
          A sua privacidade é importante para nós. É política do Melhores Filmes
          respeitar a sua privacidade em relação a qualquer informação sua que
          possamos coletar no site Melhores Filmes, e outros sites que possuímos
          e operamos.
        </Text>
        ...
        <Text style={estilos.texto}>
          ...
          informação que o Melhores Filmes oferece no site e com caráter
        ...
        <Text style={estilos.texto}>
          ...
          (softwares) do Melhores Filmes, de seus fornecedores ou terceiros,
