...
const Sobre = () => {
  return (
    <SafeAreaView>
      <Text style={estilos.titulo}>Sobre o app Melhores Filmes</Text>
      <Text style={estilos.texto}>
        O <Text style={estilos.nomeApp}>Melhores Filmes</Text> é um aplicativo
      ...
      <Text style={estilos.texto}>Melhores Filmes &copy; 2022</Text>
    </SafeAreaView>
  );
};
